export default class {
    debugSetup() {
        $('#sendQuery').on('click', () =>
            this.getRequest('query-federation', this.renderQuery, this.getQueryString()));
        $('#signalFederation').on('click', () =>
            this.getRequest('signal-federation', null, "?target_time=" + $("#nextTimeStep").val()));
    ...
    getRequest(endpoint, callback = null, query_string = null) {
